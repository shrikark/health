...
use healthlife\UserBundle\Form\SymptomType;
...
class SymptomController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('healthlifeUserBundle:Symptom')->findAll();
     ...
     * @Method("POST")
     * @Template("healthlifeUserBundle:Symptom:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('healthlifeUserBundle:Symptom')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("healthlifeUserBundle:Symptom:edit.html.twig")
     */
